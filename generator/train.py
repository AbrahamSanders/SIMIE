...
Adapted from Rostyslav Neskorozhenyi's DialoGPT fine-tuning notebook. Modified to work
with our dialog-narrative dataset.
...
# TODO: implement these as command line arguments
class Args():
    def __init__(self):
        self.train_dataset_file = 'train.txt'
        self.validation_dataset_file = 'dev.txt'
...
def main():
    ...
    df_trn = args.train_dataset_file
    df_val = args.validation_dataset_file
